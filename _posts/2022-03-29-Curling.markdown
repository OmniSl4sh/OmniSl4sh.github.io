---
layout: post
title:  "HTB Writeup [Linux - Easy] - Curling (Intro to Dante Track #4)"
---

![Curling](/assets/Curling/Curling.png)
...
![Homepage](/assets/curling/Homepage.jpg)
...
![Joomla-Version](/assets/curling/Joomla-Version.jpg)
...
![searchsploit](/assets/curling/searchsploit.jpg)
...
![joomscan-help](/assets/curling/joomscan-help.jpg)
...
![secret-comment](/assets/curling/secret-comment.jpg)

we can get a cleaner view if we grep for comments after *curling* the page:

![comment-curl](/assets/curling/comment-curl.jpg)

*Anyway,* we browse to `/secret.txt` to find some text:

![secret](/assets/curling/secret.jpg)
...
![cracked](/assets/curling/Cracked.jpg)
...
![logged-in](/assets/curling/logged-in.jpg)
...
![revvy](/assets/curling/revvy.jpg)
...
![Floris-Home](/assets/curling/Floris-Home.jpg)
...
![got-floris](/assets/curling/got-floris.jpg)
...
![configuration.php](/assets/curling/configuration.php.jpg)

### DB Enumeration

we use the the creds to enumerate the database. but find nothing special there.

![db-login](/assets/curling/db-login.jpg)
...
![admin-area](/assets/curling/admin-area.jpg)

we check their contents:

![input-report-files](/assets/curling/input-report-files.jpg)
...
![running-curl](/assets/curling/running-curl.jpg)
...
![modify-for-shadow](/assets/curling/modify-for-shadow.jpg)

and we manage to get the `shadow` file contents :D so it works!

![got-shadow](/assets/curling/got-shadow.jpg)
...
![mkpasswd](/assets/curling/mkpasswd.jpg)
...
![shadow-diff](/assets/curling/shadow-diff.jpg)
...
![gotcha](/assets/curling/gotcha.jpg)